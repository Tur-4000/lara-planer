...
<body id="app">
    <nav class="navbar navbar-expand-lg navbar-dark navbar-planer"
{{--         style="background-color: #800080;"--}}
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown mr-2">
                        ...
                        <div class="dropdown-menu  dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="{{ route('planer.admin.categories.index') }}">
    ...
    <footer class="footer">
        <div class="container-fluid px-5">
            <span class="float-right">&copy; @php echo date('Y'); @endphp &ndash; Planer</span>
        </div>
    </footer>
</body>
</html>
